...
当用户说自己对于 mewcode 的新增功能的初步想法的时候，要用「生成 spec 三份文档的模板生成 spec 三份文档的模板工作流」，生成的三份文档放在根目录的 docs 目录下
...
每次更新代码后，把对应的Readme.md中的Setup文档也对应更新
环境配置使用uv环境

uv初始安装使用requirements.txt方便后续增添依赖